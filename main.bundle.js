...
var FeedComponent = (function () {
    ...
    FeedComponent.prototype.getAllWallPosts = function (_a) {
        var _this = this;
        var owner_id = _a.owner_id, user_id = _a.user_id, user_access_token = _a.user_access_token, count = _a.count;
        var offsetsCount = 0;
        ...
        var httpRequest = function (offset, callback) {
            ...
            return _this.appService.getWallPosts({
                ...
                postsAvailable = response.available;
                return callback(response.posts);
            });
        };
