...
var FeedComponent = (function () {
    ...
    FeedComponent.prototype.getWallPosts = function (_a) {
        var _this = this;
        var owner_id = _a.owner_id, count = _a.count, user_access_token = _a.user_access_token, _b = _a.posts, posts = _b === void 0 ? [] : _b;
        return this.appService.getWallPosts({
            ...
            if (response) {
                ...
                if (count > 100) {
                    _this.postsOffset += 100;
                    count -= 100;
                }
                else {
                    _this.postsOffset += count;
                }
                _this.postsAvailable = response.available;
                posts = posts.concat(response.posts);
                if (_this.postsOffset <= count && _this.postsOffset <= _this.postsAvailable) {
                    return _this.getWallPosts({ owner_id: owner_id, count: count, user_access_token: user_access_token, posts: posts });
                }
                else {
                    return posts;
                }
